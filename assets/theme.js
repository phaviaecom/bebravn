...
(function () {
        ...
        if (slides.length > 1) {
          var sliderArgs = {
            ...
            autoPlay: this.slideshow.dataset.autoplay === 'true' ?
              parseInt(this.slideshow.dataset.speed) : false
          };
  ...
  theme.HeaderSection = (function () {
    ...
    HeaderSection.prototype = Object.assign({}, HeaderSection.prototype, {
      ...
      initDisclosures: function () {
        ...
        /* HC - Mobile currency selector */
        var localeElMobile = document.querySelector('[data-disclosure-locale-drawer]');
        var currencyElMobile = document.querySelector('[data-disclosure-currency-drawer]');

        if (localeElMobile) {
          this.localeDisclosureDrawer = new theme.Disclosure(localeElMobile);
        }

        if (currencyElMobile) {
          this.currencyDisclosureDrawer = new theme.Disclosure(currencyElMobile);
        }
      },
            ...
            evt.target.activeElement.querySelector('#quickview-trigger-klaviyo')?.addEventListener('click', (e) => {
              ...
              document.getElementById(`btn_email_subcriber-${productID}`).addEventListener('click', (event) => {
                ...
                if (regexEmail.test(emailSubcriber)) {
                  ...
                  formdata.append("variant", `${variantOption}`);
  ...
  DOMready(function () {
    ...
    //Handle on collection page - When page reload in ajax
